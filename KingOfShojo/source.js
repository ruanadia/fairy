...
var _Sources = (() => {
  ...
  var KingOfShojo_exports = {};
  __export(KingOfShojo_exports, {
    KingOfShojo: () => KingOfShojo,
    KingOfShojoInfo: () => KingOfShojoInfo
  });
  ...
  var KingOfShojo = class extends import_types2.Source {
    constructor() {
      super(...arguments);
    ...
    async getHomePageSections(sectionCallback) {
      ...
      sectionCallback(sectionLatest);
      const seriesItems = [];
      for (const item of $2("#sidebar .serieslist.pop ul li").toArray()) {
  ...
  return __toCommonJS(KingOfShojo_exports);
})();
